...
folder_data='/mnt/c/workspace/data/radar/cleanData_radar_2'
file_radar = folder_data+'/DataRadar_2'+'_' + time+'.csv'
...
def listener():
        ...
        rospy.Subscriber("RadarRange_2", Range,radarConCallBack)
        rospy.spin()

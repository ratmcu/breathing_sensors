...
class MainClass(object):
    def __init__(self, radarNumber = 1, getExternal = False,simfilepath=None,resultsFileName=None,bbeltFile=None,useX4 = None,simulate = None, port=None):
        ...
        if self.USE_X4:
            ...
            self.DIRECTORY_PATH = '/home/isuru/combined_system/data/radarData/rawData_radar_{0}/'.format(radarNumber)+ time.strftime(u"%Y%m%d")
        else:
...
if __name__ == '__main__':
    ...
    #     os.makedirs('logs')
    rd1 = MainClass(radarNumber = 1, port='/dev/serial/by-path/pci-0000:00:14.0-usb-0:1:1.0')
    rd2 = MainClass(radarNumber = 2, port='/dev/serial/by-path/pci-0000:00:14.0-usb-0:2:1.0')
    ...
    #     rd_thread_2.pauseEvent.clear()
    #     rd_thread_2.resumeEvent.set()
    proc = subprocess.Popen(['python3', 'bb2main.py'])
    pid = proc.pid
    try:
        while True:
            pass
    except KeyboardInterrupt:
        print('signalling interruption')

...
DIRECTORY_PATH = '/home/isuru/combined_system/data/breathingBeltRawData/' + time.strftime(u"%Y%m%d") + '/'
...
if __name__ == '__main__':
    ...
    sensor_threads = []
    for device in godirect_devs.devices:
    ...
    try:
        ...
        # while True:
        #     pass
        sensor_threads[0].join() # a little trick to avoid exceptions upon SIGINT
    except KeyboardInterrupt:
        print('stopping breathing belts')
        for t in sensor_threads:
            t.do_run = False
            t.join()
